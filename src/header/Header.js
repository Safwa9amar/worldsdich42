...
import nav_bg from "../asstes/bg/nav_bg.png";
import Logo from "../asstes/logo.png";
import burger from "../iamges/buger.png";
  ...
  return (
    <div
      ...
      className="w-full md:w-[95vw] md:mx-[2.5vw]
                 md:mt-5 rounded-xl relative
                 h-1/2 md:h-4/6 lg:h-4/5
                 "
    >
      <div className="h-full w-full p-4 absolute z-20 text-white">
        ...
        <div className="flex justify-between lg:mx-6 w-full lg:mt-4">
          <div className="relative">
            ...
            <p
              className="text-3xl md:text-6xl lg:text-8xl ml-10  text-shadow-lg text-shadow-white "
              style={{
          ...
          <div className="w-1/3 md:w-1/4 mt-[10%]">

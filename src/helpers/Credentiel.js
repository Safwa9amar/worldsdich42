...
export default function CredentielClient({ setcheckBoxState, checkBoxState }) {
        ...
        <div className="relative" >
          ...
          {login && (
            <form onSubmit={handleSubmit} >
                <p className="text-lg md:text-2xl">S'identifier</p>
          ...
          {regsitre && (
              <form onSubmit={handleSubmit}>
                <p className="text-lg md:text-2xl">Créer un nouveau compte</p>
